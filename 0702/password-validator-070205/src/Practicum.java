...
class Practicum {
    ...
    private static final List<Validator> nameValidators = List.of(new validators.NameValidator()); // поработайте со списком
    ...
    private static void addUser() {
        ...
        try {
            ...
            storage.close();
            // } catch (IOException e) {
            //     System.out.println("Ошибка при закрытии хранилища: " + e.getMessage());
        }
